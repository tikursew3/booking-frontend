...
<header className="w-full z-50 bg-[#a18132]/70 backdrop-blur-md shadow-md">
{/* <header className="fixed top-0 left-0 w-full z-50 h-16 bg-white/30 backdrop-blur-md supports-[backdrop-filter]:bg-white/20 shadow-md"> */}
      ...
      {/* Mobile menu */}
      {isOpen && (
        <div className="md:hidden bg-[#a18132]/70 backdrop-blur-sm px-4 py-4 shadow rounded-b-2xl">
