...
export default function Header() {
  ...
  return (
    ...
    <header className="absolute top-0 left-0 w-full z-50 bg-white/30 backdrop-blur-md supports-[backdrop-filter]:bg-white/20 shadow-md">
      ...
      {/* Mobile menu */}
      {isOpen && (
        <div className="md:hidden bg-white/10 backdrop-blur-sm px-4 py-4 shadow rounded-b-2xl">
