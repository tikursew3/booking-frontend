...
export default function BookingsPage() {
  ...
  const [typeFilter, setTypeFilter] = useState<"ALL" | "PHOTOGRAPHY" | "CONSULTATION">("ALL");
  const [statusFilter, setStatusFilter] = useState<"ALL" | "CONFIRMED" | "PENDING" | "CANCELLED">("CONFIRMED");
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
        <div>
            ...
            <select
            value={typeFilter}
            onChange={(e) => setTypeFilter(e.target.value as "ALL" | "PHOTOGRAPHY" | "CONSULTATION")}
          ...
          {bookings
            ...
            .map((b) => (
              <tr key={b.id} className="border-t">
                ...
                <td className="p-3">{new Date(b.startDateTime).toLocaleString()}</td>
      ...
      >
        ...
        <input
          ...
          onChange={(e) => {
            ...
            setEditingBooking({ ...editingBooking, startDateTime: newStart, endDateTime: newEnd });
          }}
          className="w-full border rounded px-4 py-2"
          required
        />
